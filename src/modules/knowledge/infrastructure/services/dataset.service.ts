...
export class DatasetService {
    ...
    constructor(
        ...
        this.bucketName = this.configService.get<string>('MINIO_BUCKET_NAME') || 'datasets';
    ...
    async handleFileUpload(file: Express.Multer.File, userId: string): Promise<BucketFile> {
        try {
